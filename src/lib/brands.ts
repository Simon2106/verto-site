...
// Round 5, item 1: the hydro dam is gone (Edison does zero hydro) – pylons
// are the interim Edison imagery until the client purchases the CCGT /
// turbine photography they've chosen (see verto-core/CLIENT-NEEDS.md).
import pylonAsset from "@/assets/pylon-2.webp";
const edisonHero = pylonAsset;
...
export const BRANDS: Record<BrandSlug, BrandDefinition> = {
  "edison-lux": {
    ...
    heroAlt: "Silhouetted electricity transmission pylons at sunset with a substation on the horizon",
    stats: [
